...
# if __name__ == "__main__":
    # test_resume = generate_resume("Mahruful Alam", "Software Developer", "2","Python, AI, Web Development", "B.Sc. CS", "Experienced in AI and cloud computing.")
...
#     )
#     pdf_resume = generate_pdf_resume(resume_text)
#     print(pdf_resume)
