...
# if __name__ == "__main__":
#     test_resume = "Name: Mahruful Alam, Experience: 1 years in Software Development, Skills: Python,Django,DRF,AI Enthusiast, Education: B.Sc. in Computer Science Engineering"
#     test_job_description = "Role: Backend Developer, Required Skills: Python, Django, SQL, API Development, Experience: 3+ years"
